<div class="col-lg-4">
   <div class="right_sidebar">
      ...
      <aside class="r_widgets social_widgets mt-5">
         ...
         <ul class="list">
            <li><a href="#"><i class="fa fa-facebook"></i>Netindo.news<span>Like our page</span></a></li>
            <li><a href="#"><i class="fa fa-twitter"></i>Netindo.news<span>Follow Us</span></a></li>
            <li><a href="#"><i class="fa fa-youtube-play"></i>Netindo.news<span>Subscribe</span></a></li>
         </ul>
      </aside>
