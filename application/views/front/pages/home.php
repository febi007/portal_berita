      ...
      <div class="container">
            <div class="row">
               <div class="col-lg-6 col-sm-4">
                  <h4 class="float-right my-2 text-dark col-sm-12">Subscribe to our Newsletter</h4>
               </div>
         ...
         <div class="col-lg-8">
            ...
            <div class="latest_news">
               <?php foreach($lastNews as $ln)  :?>
                  <div class="media">
                     <div class="d-flex">
                        <img class="img-fluid gambar_tambahan" src="<?= base_url("images/posting/medium/$ln->photo") ?>" alt="">
                     </div>
                     <div class="media-body config_tambahan">
                        <div class="choice_text">
                           <div class="date">
